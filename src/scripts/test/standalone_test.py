...
if __name__ == "__main__":
    ...
    print("## Generating and recording test signal... ##")
    ...
    print("## Done Weiner deconvolution .... ##")
#######################################################################################################################
    print("## Plotting .... ##")
